...
const Navbar = ({ toggleDarkMode, darkMode }) => {
  ...
  return (
    <nav className={`fixed object-bottom w-full z-10 top-0 shadow-md ${darkMode ? "bg-neutral-800 text-white" : "bg-white text-gray-900"} transition-colors duration-200`}>
